    ...
    const Community = {
            ...
            if (postForm) {
                ...
                postForm.onsubmit = async (e) => {
                    ...
                    try {
                        ...
                        const res = await fetch('/includes/community_api.php', {
        ...
        async loadPosts() {
            ...
            try {
                ...
                const res = await fetch(`/includes/community_api.php?action=fetchPosts&type=${this.activeFilter}&sort=${this.activeSort}`);
        ...
        async handleReaction(postId, type) {
            ...
            try {
                ...
                const res = await fetch('/includes/community_api.php', { method: 'POST', body: formData });
        ...
        async loadBikeRatings() {
            ...
            try {
                ...
                const res = await fetch('/includes/community_api.php?action=getBikeRatings');
